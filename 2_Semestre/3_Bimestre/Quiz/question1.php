...
<html lang="pt-br">
  ...
  <body>
    ...
    <form action="./question1.php" method="post">
      <div class="mb-3"><h1>Existem somente 10 tipos de pessoas que entendem binário! Qual é a resposta correta?</h1>
        <input type="radio" id="question1" name="question1" value="10">
        <label for="question1">Somente 10</label>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <label for="question1">Somente 2</label>
    </div>
