...
<head>
    ...
    <link rel="stylesheet" href="ccs/style-work.css">
</head>
<body>
  ...
  <div class="container d-flex justify-content-between align-items-center">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarDesktop">
      <ul class="navbar-nav align-items-center gap-4">
        ...
        <li class="nav-item">
          <a class="nav-link text-white fw-semibold" href="#">Ferramentas</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white fw-semibold" href="anuncios.php">Voltar ao inicio</a>
        </li>
        <li class="nav-item">
