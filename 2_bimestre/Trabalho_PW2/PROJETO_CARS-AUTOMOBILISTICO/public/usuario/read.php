       ...
       <head>
         ...
         <link rel="stylesheet" href="../css/style-anuncios.css">
       ...
       <body>
         ...
         <div class="contain d-flex">
           <div class="col-2 sidebar d-flex flex-column align-items-center" id="contain1">
             <button class="it1 btn btn-dark">VENDAS FEITAS</button>
             <button class="it2 btn btn-dark">CLIENTES</button>
             <button class="it3 btn btn-dark"> PACERIAS</button>
           </div>
               ...
               <?php foreach ($anuncios as $indice => $cars) { ?>
                 <div class="col-md-6">
                   <div class="card-anuncio">
                     ...
                     <?php } ?>
                     <div class="btn-group">
                       <a href="./delete.php?Id=<?= $cars['Id']; ?>" class="btn btn-custom">Remover</a>
                       <a href="./update.php?Id=<?= $cars['Id']; ?>" class="btn btn-custom">Atualizar</a>
                     </div>
                   </div>
                 </div>
               <?php } ?>
